...
const Testimonial = () => {
  ...
  return (
    <section
      id='testimonial'
      className='w-full py-20 border-b-[1px] border-b-black px-6'
    >
      ...
      <div className='max-w-6xl mx-auto  '>
        <Slider {...settings}>
          <div className='w-full'>
            <div className='w-full h-auto gap-6 flex flex-col lgl:flex-row lgl:justify-between'>
              <div className='w-full lgl:w-[35%] h-full bg-gradient-to-r from-[#1e2024] to-[#23272b] shadow-shadowOne p-8 rounded-lg flex flex-col md:flex-row lgl:flex-col gap-8 justify-center md:justify-start lgl:justify-center'>
                <img
                  className='lgl:h-[300px] lgl:w-[350px] w-[310px] h-[260px] md:h-[150px] md:w-full rounded-lg object-cover '
              ...
              <div className='w-full lgl:w-[60%] h-full'>
                ...
                <div className='w-full h-[70%] py-10 bg-gradient-to-r from-[#1e2024] to-[#23272b ] rounded-lg shadow-shadowOne mt-2 lgl:mt-11 p-4 lgl:p-8 justify-center flex flex-col gap-4 lgl:gap-8'>
          ...
          <div className='w-full'>
            <div className='w-full h-auto gap-6 flex flex-col lgl:flex-row justify-between'>
              <div className='w-full lgl:w-[35%] h-full bg-gradient-to-r from-[#1e2024] to-[#23272b] shadow-shadowOne p-8 rounded-lg flex flex-col md:flex-row lgl:flex-col gap-8 justify-center md:justify-start lgl:justify-center'>
                <img
                  className='lgl:h-[300px] lgl:w-[350px] w-[310px] h-[260px] md:h-[150px] md:w-full rounded-lg object-cover '
              ...
              <div className='w-full lgl:w-[60%] h-full'>
                <FaQuoteRight className='w-[50px] h-[50px] lgl:w-[100px] lgl:h-[100px]' />
                <div className='w-full h-[70%] py-10 bg-gradient-to-r from-[#1e2024] to-[#23272b ] rounded-lg shadow-shadowOne mt-2 p-4 lgl:p-8 justify-center flex flex-col gap-4 lgl:gap-8'>
                  <div className='flex flex-col justify-between lgl:items-center py-6 border-b-2 border-b-gray-900'>
                    <div>
                      <h3 className='text-xl lgl:text-2xl font-medium tracking-wide'>
                        BlueSky Global Tech
